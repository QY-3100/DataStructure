	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord9 = IN.ase_texcoord8.xy * float2( 1,1 ) + _Offset;
				float4 tex2DNode1 = tex2D( _Texture, texCoord9 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord9 = IN.ase_texcoord3.xy * float2( 1,1 ) + _Offset;
				float4 tex2DNode1 = tex2D( _Texture, texCoord9 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord9 = IN.ase_texcoord4.xy * float2( 1,1 ) + _Offset;
				float4 tex2DNode1 = tex2D( _Texture, texCoord9 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord9 = IN.ase_texcoord2.xy * float2( 1,1 ) + _Offset;
				float4 tex2DNode1 = tex2D( _Texture, texCoord9 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord9 = IN.ase_texcoord5.xy * float2( 1,1 ) + _Offset;
				float4 tex2DNode1 = tex2D( _Texture, texCoord9 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord9 = IN.ase_texcoord.xy * float2( 1,1 ) + _Offset;
				float4 tex2DNode1 = tex2D( _Texture, texCoord9 );
